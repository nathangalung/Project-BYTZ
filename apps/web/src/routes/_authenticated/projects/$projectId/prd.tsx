            ...
            <div className="relative">
              <div className="pointer-events-none select-none blur-sm opacity-60 space-y-3">
                {[
                  ...
                  <div
                    key={title}
                    className="rounded-xl border border-outline-dim/10 bg-surface-bright p-5"
                  >
                    <p className="text-sm font-medium text-primary-600">{title}</p>
                    <div className="mt-3 h-3 w-3/4 rounded bg-surface-container" />
                    <div className="mt-2 h-3 w-1/2 rounded bg-surface-container" />
                  </div>
                ))}
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="mx-4 max-w-md rounded-2xl border border-outline-dim/20 bg-surface-bright p-8 text-center shadow-lg">
                  ...
                  <h3 className="text-lg font-bold text-primary-600">{t('prd_locked_title')}</h3>
                  <p className="mt-2 text-sm text-on-surface-muted">
                    {t('prd_locked_description')}
                  </p>
                  <p className="mt-4 text-2xl font-bold text-primary-600">
                    {formatCurrency(prd?.price ?? 0)}
                  </p>
                  {isOwnerViewer && (
                    <Link
                      to="/projects/$projectId/checkout"
