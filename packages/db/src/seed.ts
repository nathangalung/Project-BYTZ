...
async function seed() {
  ...
  await db
    ...
    .values([
      ...
      makePrd(
        ...
        2,
        [
          { title: 'Mobile Development', skills: ['React Native'], hours: 140, amount: 18666667 },
      ...
      makePrd(
        ...
        3,
        [
          { title: 'Backend API', skills: ['Node.js', 'PostgreSQL'], hours: 180, amount: 25882353 },
          {
            title: 'Frontend Web',
          ...
          { title: 'UI/UX Design', skills: ['Figma', 'UI Design'], hours: 80, amount: 17941176 },
        ],
      ),
      makePrd(p21Id, 'approved', 2000000, { mobile: 'Flutter', backend: 'Firebase' }, 1, [
        { title: 'Mobile App Development', skills: ['Flutter'], hours: 140, amount: 20000000 },
      ]),
      makePrd(
        p22Id,
        'approved',
    ...
    .values([
      {
        ...
        // Bracket fees on released milestones plus BRD/PRD payments.
        balance: 64240000,
        currency: 'IDR',
      },
  ...
  await db
    ...
    .values([
      // Runtime convention: debit raises a balance, credit lowers it.
      // Funding debits escrow and credits the owner; a release credits
      // escrow for the gross milestone and debits talent share plus fee.
      {
        id: uuidv7(),
        transactionId: txn1Id,
      ...
      },
      {
        id: uuidv7(),
        transactionId: txn2Id,
        accountId: platformAccId,
        entryType: 'debit' as const,
        amount: 7275000,
        description: 'Platform fee - DB Schema',
      },
      {
        id: uuidv7(),
      ...
      },
      {
        ...
        entryType: 'debit' as const,
        amount: 5025000,
        description: 'Platform fee - Redesign',
      },
      {
        id: uuidv7(),
  ...
  await db
    ...
    .values([
      ...
      // talent1 (Budi - senior, 3 completed)
      {
        ...
        type: 'payment' as const,
        title: 'Dana Cair',
        message: 'Pembayaran Rp 7.725.000 untuk milestone "Dashboard & Final Testing" dicairkan.',
        link: '/payments',
        isRead: true,
      },
      {
      ...
      // talent2 (Dewi - mid, 2 completed + 1 ongoing)
      {
        ...
        type: 'payment' as const,
        title: 'Dana Cair',
        message: 'Pembayaran Rp 5.273.333 untuk milestone "Mobile UI Foundations" dicairkan.',
        link: '/payments',
        isRead: false,
      },
      {
      ...
      },
      {
        ...
        type: 'payment' as const,
        title: 'Dana Cair',
        message: 'Pembayaran Rp 12.875.000 untuk milestone "GPS Tracking Core" dicairkan.',
        link: '/payments',
        isRead: true,
      },
      {
  ...
  const activityData: Array<{
    ...
    },
    {
      ...
      title: 'Dana Rp 5.273.333 dicairkan ke Dewi',
