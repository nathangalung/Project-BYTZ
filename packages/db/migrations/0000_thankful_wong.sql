...
CREATE TYPE "public"."worker_tier" AS ENUM('junior', 'mid', 'senior');--> statement-breakpoint
CREATE TYPE "public"."acceptance_status" AS ENUM('pending', 'accepted', 'declined');--> statement-breakpoint
CREATE TYPE "public"."activity_type" AS ENUM('message_sent', 'milestone_submitted', 'milestone_approved', 'milestone_rejected', 'revision_requested', 'payment_made', 'payment_released', 'file_uploaded', 'status_changed', 'worker_assigned', 'worker_replaced', 'worker_declined', 'team_formed', 'review_posted', 'dispute_opened', 'dispute_resolved', 'project_on_hold', 'project_resumed');--> statement-breakpoint
...
CREATE TYPE "public"."chat_conversation_type" AS ENUM('ai_scoping', 'client_worker', 'team_group', 'worker_worker', 'admin_mediation');--> statement-breakpoint
...
CREATE TYPE "public"."resolution_type" AS ENUM('funds_to_worker', 'funds_to_client', 'split');--> statement-breakpoint
...
CREATE TYPE "public"."account_owner_type" AS ENUM('platform', 'client', 'worker', 'escrow');--> statement-breakpoint
...
CREATE TYPE "public"."review_type" AS ENUM('client_to_worker', 'worker_to_client');--> statement-breakpoint
...
CREATE TABLE "worker_profiles" (
	...
	"tier" "worker_tier" DEFAULT 'junior' NOT NULL,
...
CREATE TABLE "contracts" (
	...
	"content" jsonb NOT NULL,
	"signed_by_client" boolean DEFAULT false NOT NULL,
	"signed_by_worker" boolean DEFAULT false NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "mv_worker_stats" (
	"id" integer PRIMARY KEY DEFAULT 1 NOT NULL,
	"total_workers" integer,
	"workers_by_tier" jsonb,
	"avg_projects_per_worker" real,
	"avg_rating" real,
...
ALTER TABLE "worker_assessments" ADD CONSTRAINT "worker_assessments_worker_id_worker_profiles_id_fk" FOREIGN KEY ("worker_id") REFERENCES "public"."worker_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "worker_assessments" ADD CONSTRAINT "worker_assessments_reviewer_id_user_id_fk" FOREIGN KEY ("reviewer_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "worker_penalties" ADD CONSTRAINT "worker_penalties_worker_id_worker_profiles_id_fk" FOREIGN KEY ("worker_id") REFERENCES "public"."worker_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "worker_penalties" ADD CONSTRAINT "worker_penalties_issued_by_user_id_fk" FOREIGN KEY ("issued_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "worker_profiles" ADD CONSTRAINT "worker_profiles_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "worker_skills" ADD CONSTRAINT "worker_skills_worker_id_worker_profiles_id_fk" FOREIGN KEY ("worker_id") REFERENCES "public"."worker_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "worker_skills" ADD CONSTRAINT "worker_skills_skill_id_skills_id_fk" FOREIGN KEY ("skill_id") REFERENCES "public"."skills"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "milestones" ADD CONSTRAINT "milestones_assigned_worker_id_worker_profiles_id_fk" FOREIGN KEY ("assigned_worker_id") REFERENCES "public"."worker_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "project_applications" ADD CONSTRAINT "project_applications_worker_id_worker_profiles_id_fk" FOREIGN KEY ("worker_id") REFERENCES "public"."worker_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "project_assignments" ADD CONSTRAINT "project_assignments_worker_id_worker_profiles_id_fk" FOREIGN KEY ("worker_id") REFERENCES "public"."worker_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_assigned_worker_id_worker_profiles_id_fk" FOREIGN KEY ("assigned_worker_id") REFERENCES "public"."worker_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "time_logs" ADD CONSTRAINT "time_logs_worker_id_worker_profiles_id_fk" FOREIGN KEY ("worker_id") REFERENCES "public"."worker_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "talent_placement_requests" ADD CONSTRAINT "talent_placement_requests_client_id_user_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "talent_placement_requests" ADD CONSTRAINT "talent_placement_requests_worker_id_worker_profiles_id_fk" FOREIGN KEY ("worker_id") REFERENCES "public"."worker_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_worker_id_worker_profiles_id_fk" FOREIGN KEY ("worker_id") REFERENCES "public"."worker_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "worker_skills_pk" ON "worker_skills" USING btree ("worker_id","skill_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "project_applications_unique" ON "project_applications" USING btree ("project_id","worker_id");--> statement-breakpoint
