...
export const ERROR_I18N_KEYS: Record<ErrorCode, string> = {
  ...
  DOCUMENT_DAILY_LIMIT: 'errors.document.daily_limit',
  DOCUMENT_REVISION_LIMIT: 'errors.document.revision_limit',
  DOCUMENT_NOT_PAID: 'errors.document.not_paid',
  ...
  MATCHING_NO_WORK_PACKAGES: 'errors.matching.no_work_packages',
  MATCHING_INVALID_ASSIGNMENT: 'errors.matching.invalid_assignment',
